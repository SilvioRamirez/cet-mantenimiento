<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
	<div class="container-fluid">
		<a class="navbar-brand" href="{{ url('/') }}">Mantenimiento de Hardware & Software </a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<ul class="navbar-nav me-auto">
			@can('user-list')
				<li><a class="nav-link" href="{{ route('users.index') }}"><i class="fa-solid fa-users"></i>&nbsp;Usuarios</a></li>
			@endcan
			@can('role-list')
				<li><a class="nav-link" href="{{ route('roles.index') }}"><i class="fa-sharp fa-solid fa-users-gear"></i>&nbsp;Roles & Permisos</a></li>
			@endcan
			<!--@can('product-list')
				<li><a class="nav-link" href="{{ route('products.index') }}">Productos</a></li>
			@endcan-->
      @can('dependencia-list')
				<li><a class="nav-link" href="{{ route('dependencia.index') }}"><i class="fa-solid fa-building"></i>&nbsp;Dependencias</a></li>
			@endcan
      @can('empleado-list')
				<li><a class="nav-link" href="{{ route('empleados.index') }}"><i class="fa-sharp fa-solid fa-user-tie"></i>&nbsp;Empleados</a></li>
			@endcan
      @can('equipo-list')
				<li><a class="nav-link" href="{{ route('equipos.index') }}"><i class="fa-sharp fa-solid fa-network-wired"></i>&nbsp;Equipos</a></li>
			@endcan
        </ul>
