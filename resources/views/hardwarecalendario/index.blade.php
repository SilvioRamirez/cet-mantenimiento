    ...
    <div class="row">
        <div class="col-lg-12 margin-tb"><br>
            <div class="text-center">
                <h1><i class="fa fa-calendar-alt"></i>&nbsp;Calendario de Hardware</h1>
            </div><br>
        </div>
    </div>
      <!-- fullcalendar -->    
...
var calendarEl = document.getElementById('calendariohardware');
      ...
      var calendar = new FullCalendar.Calendar(calendarEl, {
          ...
          events: SITEURL + "/calendar-event-hardware",
          editable: true,
          ...
          eventClick: function (event) {
              ...
              if (eventDelete) {
                ...
                var url = SITEURL + '/calendar-crud-ajax-hardware';
                axios.post(url, {
                    id: id,
                    type: 'delete'
                }).then(response => {
        ...
        document.getElementById("btnGuardar").addEventListener("click",function(){
            ...
            var url = '/hardwarecalendario/store_ajax';
